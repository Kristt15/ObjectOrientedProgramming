public class Main {
    public static void main(String[] args) {
        ...
        daftarWahana[0] = new KomidiPutar(
                "K01", "Komidi Putar 01", 10, 5000, 10000);

        daftarWahana[1] = new KomidiPutar(
                "K02", "Komidi Putar 02", 12, 5000, 12000);

        daftarWahana[2] = new KomidiPutar(
                "K03", "Komidi Putar 03", 15, 7000, 15000);

        daftarWahana[3] = new KomidiPutar(
                "K04", "Komidi Putar 04", 10, 5000, 10000);

        daftarWahana[4] = new KomidiPutar(
                "K05", "Komidi Putar 05", 20, 7000, 20000);
